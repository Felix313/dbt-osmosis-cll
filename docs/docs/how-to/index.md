...
How-to guides are **goal-oriented**: they assume you know the basics and want to accomplish a specific task.

## Common tasks

- [Run dbt-osmosis on-demand, in pre-commit, or CI](../tutorial-yaml/workflow)
