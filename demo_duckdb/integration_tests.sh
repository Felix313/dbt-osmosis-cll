...
# Run the tests
dbt-osmosis-cll yaml organize --auto-apply "${common_options[@]}"
dbt-osmosis-cll yaml document "${common_options[@]}"
dbt-osmosis-cll yaml refactor --auto-apply "${common_options[@]}"
dbt-osmosis-cll yaml --help >/dev/null
