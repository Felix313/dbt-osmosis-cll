...
class TestConfigResolver:
    ...
    def test_project_vars_source(self) -> None:
        ...
        # Test dbt_osmosis_cll snake_case prefix
...
""",
    ...
    def test_invalid_yaml_error_handling(self, tmp_path: Path) -> None:
        ...
        from dbt_osmosis_cll.osmosis_propagation.introspection import ConfigurationError
...
class TestBackwardCompatibility:
    ...
    def test_exports_available_from_osmosis(self) -> None:
        ...
        from dbt_osmosis_cll.osmosis_propagation.osmosis import PropertyAccessor, SettingsResolver
