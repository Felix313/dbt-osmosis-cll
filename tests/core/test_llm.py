...
from dbt_osmosis_cll.osmosis_propagation.exceptions import LLMConfigurationError, LLMResponseError
...
def test_get_llm_client_azure_ad_with_service_principal(
    ...
    with mock.patch(
        "dbt_osmosis_cll.osmosis_propagation.commands.llm.EnvironmentCredential.get_token",
...
def test_get_llm_client_azure_ad_with_default_credential(
    ...
    with mock.patch(
        "dbt_osmosis_cll.osmosis_propagation.commands.llm.DefaultAzureCredential.get_token",
...
def test_get_llm_client_azure_ad_without_azure_identity(
    ...
    with mock.patch("dbt_osmosis_cll.osmosis_propagation.commands.llm._AZURE_IDENTITY_AVAILABLE", False):
        with pytest.raises(
            LLMConfigurationError,
