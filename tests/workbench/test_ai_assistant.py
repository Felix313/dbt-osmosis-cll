...
def _load_ai_assistant_module(monkeypatch):
    ...
    monkeypatch.delitem(sys.modules, "dbt_osmosis_cll.osmosis_propagation.commands.workbench.components.dashboard", raising=False)
    monkeypatch.delitem(sys.modules, "dbt_osmosis_cll.osmosis_propagation.commands.workbench.components.ai_assistant", raising=False)

    module = importlib.import_module("dbt_osmosis_cll.osmosis_propagation.commands.workbench.components.ai_assistant")
