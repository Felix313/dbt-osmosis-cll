...
def _synthesize_bulk_documentation(
    ...
    """
    from dbt_osmosis_cll.osmosis_propagation.commands.llm import generate_model_spec_as_json
...
def _synthesize_node_documentation(
    ...
    """
    from dbt_osmosis_cll.osmosis_propagation.commands.llm import generate_table_doc
...
def _synthesize_individual_column_documentation(
    ...
    """
    from dbt_osmosis_cll.osmosis_propagation.commands.llm import generate_column_doc
...
def synthesize_missing_documentation_with_openai(
    ...
    try:
        ...
        importlib.util.find_spec("dbt_osmosis_cll.osmosis_propagation.commands.llm")
    except ImportError:
        raise ImportError(
...
def apply_semantic_analysis(
    ...
    try:
        from dbt_osmosis_cll.osmosis_propagation.commands.llm import analyze_column_semantics, generate_semantic_description
...
def suggest_improved_documentation(
    ...
    if needs_model_doc or has_poor_model_doc:
        from dbt_osmosis_cll.osmosis_propagation.commands.llm import suggest_documentation_improvements
