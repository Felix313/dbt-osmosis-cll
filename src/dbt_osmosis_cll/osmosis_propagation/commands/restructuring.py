...
def draft_restructure_delta_plan(context: YamlRefactorContextProtocol) -> RestructureDeltaPlan:
    ...
    from dbt_osmosis_cll.osmosis_propagation.path_management import build_yaml_file_mapping
...
def apply_restructure_plan(
    ...
    *,
    ...
    from dbt_osmosis_cll.osmosis_propagation.schema.writer import commit_yamls
