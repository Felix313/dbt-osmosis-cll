...
class MigrationPlanner:
    ...
    Example:
        >>> from dbt_osmosis_cll.osmosis_propagation.commands.migration import MigrationPlanner
    ...
    def _sort_changes_by_dependency(
        ...
        """
        from dbt_osmosis_cll.osmosis_propagation.commands.diff import ChangeCategory
