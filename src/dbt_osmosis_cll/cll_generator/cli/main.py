...
from dbt_osmosis_cll.cll_generator.lineage.display import TextDisplay, DotDisplay
from dbt_osmosis_cll.cll_generator.lineage.display.html.explore import LineageExplorer
from dbt_osmosis_cll.cll_generator.lineage.service import LineageService, LineageSelector
from dbt_osmosis_cll.cll_generator.lineage.display.base import LineageStaticDisplay
...
@click.option(
    "--profiles-dir", default=".", help="Directory containing profiles.yml (used with --live-db)"
)
@click.option("--project-dir", default=".", help="dbt project root directory (used with --live-db)")
@click.option("--target", default=None, help="dbt target profile name (used with --live-db)")
@click.option(
    "--format",
    "-f",
